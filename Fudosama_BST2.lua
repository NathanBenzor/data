...
function user_setup()
    ...
    physical_ready_moves = S {'Foot Kick', 'Whirl Claws', 'Sheep Charge', 'Lamb Chop', 'Head Butt', 'Wild Oats',
                              'Leaf Dagger', 'Claw Cyclone', 'Razor Fang', 'Crossthrash', 'Nimble Snap', 'Cyclotail',
                              'Rhino Attack', 'Power Attack', 'Mandibular Bite', 'Big Scissors', 'Grapple',
                              'Spinning Top', 'Double Claw', 'Frogkick', 'Blockhead', 'Brain Crush', 'Tail Blow',
                              'Scythe Tail', 'Ripper Fang', 'Chomp Rush', 'Needleshot', 'Recoil Dive', 'Sudden Lunge',
                              'Spiral Spin', 'Wing Slap', 'Beak Lunge', 'Suction', 'Back Heel', 'Fantod',
                              'Tortoise Stomp', 'Sensilla Blades', 'Tegmina Buffet', 'Pentapeck', 'Sweeping Gouge',
                              'Somersault', 'Tickling Tendrils', 'Pecking Flurry', 'Sickle Slash', 'Disembowel',
                              'Extirpating Salvo', 'Mega Scissors', 'Rhinowrecker', 'Hoof Volley', 'Fluid Toss',
                              'Fluid Spread'}
    ...
    tp_based_ready_moves = S {'Foot Kick', 'Dust Cloud', 'Snow Cloud', 'Sheep Song', 'Sheep Charge', 'Lamb Chop',
                              'Head Butt', 'Scream', 'Dream Flower', 'Wild Oats', 'Leaf Dagger', 'Claw Cyclone',
                              'Razor Fang', 'Roar', 'Gloeosuccus', 'Palsy Pollen', 'Soporific', 'Cursed Sphere',
                              'Somersault', 'Geist Wall', 'Numbing Noise', 'Frogkick', 'Nimble Snap', 'Cyclotail',
                              'Spoil', 'Rhino Attack', 'Hi-Freq Field', 'Sandpit', 'Sandblast', 'Mandibular Bite',
                              'Metallic Body', 'Bubble Shower', 'Grapple', 'Spinning Top', 'Double Claw', 'Spore',
                              'Filamented Hold', 'Blockhead', 'Fireball', 'Tail Blow', 'Plague Breath', 'Brain Crush',
                              'Infrasonics', 'Needleshot', 'Chaotic Eye', 'Blaster', 'Ripper Fang', 'Intimidate',
                              'Recoil Dive', 'Water Wall', 'Sudden Lunge', 'Noisome Powder', 'Wing Slap', 'Beak Lunge',
                              'Suction', 'Drainkiss', 'Acid Mist', 'TP Drainkiss', 'Back Heel', 'Jettatura',
                              'Choke Breath', 'Fantod', 'Charged Whisker', 'Purulent Ooze', 'Corrosive Ooze',
                              'Tortoise Stomp', 'Aqua Breath', 'Sensilla Blades', 'Tegmina Buffet', 'Sweeping Gouge',
                              'Tickling Tendrils', 'Pecking Flurry', 'Pestilent Plume', 'Foul Waters', 'Spider Web',
                              'Gloom Spray', 'Disembowel', 'Extirpating Salvo', 'Rhinowrecker', 'Venom Shower',
                              'Fluid Toss', 'Fluid Spread', 'Digest'}
    ...
    call_beast_cancel = S {'Vis. Broth', 'Ferm. Broth', 'Bubbly Broth', 'Windy Greens', 'Bug-Ridden Broth',
                           'Tant. Broth', 'Glazed Broth', 'Slimy Webbing', 'Deepwater Broth', 'Venomous Broth',
                           'Heavenly Broth'}
...
function init_gear_sets()
    ...
    Pet_PDT_AxeSub = {
        name = "Kumbhakarna",
        augments = {'Pet: DEF+20', 'Pet: Damage taken -4%', 'Pet: STR+14 Pet: DEX+14 Pet: VIT+14'}
    }
    ...
    Pet_Regen_AxeSub = {
        name = "Kumbhakarna",
        augments = {'Pet: Mag. Evasion+20', 'Pet: "Regen"+3', 'MND+17'}
    }

    Ready_Atk_Axe = "Aymur"
    Ready_Atk_Axe2 = "Agwu's Axe"
    Ready_Atk_TPBonus_Axe = "Aymur"
    Ready_Atk_TPBonus_Axe2 = {
        name = "Kumbhakarna",
        augments = {'Pet: Attack+25 Pet: Rng.Atk.+25', 'Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4', 'Pet: TP Bonus+200'}
    }
    ...
    Ready_MAB_Axe = {
        name = "Digirbalag",
        augments = {'Pet: Mag. Acc.+21', 'Pet: "Mag.Atk.Bns."+30', 'INT+2 MND+2 CHR+2'}
    }
    Ready_MAB_Axe2 = "Deacon Tabar"
    Ready_MAB_TPBonus_Axe = {
        name = "Kumbhakarna",
        augments = {'Pet: "Mag.Atk.Bns."+25', 'Pet: Phys. dmg. taken -4%', 'Pet: TP Bonus+200'}
    }
    Ready_MAB_TPBonus_Axe2 = {
        name = "Kumbhakarna",
        augments = {'Pet: "Mag.Atk.Bns."+22', 'Pet: Phys. dmg. taken -5%', 'Pet: TP Bonus+200'}
    }

    Ready_MAcc_Axe = {
        name = "Kumbhakarna",
        augments = {'Pet: Mag. Acc.+20', '"Cure" potency +15%', 'Pet: TP Bonus+180'}
    }
    ...
    Pet_PDT_back = {
        name = "Artio's Mantle",
        augments = {'VIT+20', 'Eva.+20 /Mag. Eva.+20', 'Evasion+10', 'Pet: "Regen"+10', 'System: 1 ID: 1246 Val: 4'}
    }
    ...
    Pet_MDT_feet = {
        name = "Taeon Boots",
        augments = {'Pet: Mag. Evasion+22', 'Pet: "Regen"+3', 'Pet: Damage taken -4%'}
    }
    Pet_MDT_back = {
        name = "Artio's Mantle",
        augments = {'INT+20', 'Eva.+20 /Mag. Eva.+20', 'Pet: "Regen"+10', 'System: 1 ID: 1247 Val: 4'}
    }

    Pet_DT_head = "Anwig Salade"
    Pet_DT_body = {
        name = "Acro Surcoat",
        augments = {'Pet: DEF+22', 'Pet: "Regen"+3', 'Pet: Damage taken -4%'}
    }
    Pet_DT_hands = {
        name = "Acro Gauntlets",
        augments = {'Pet: DEF+22', 'Pet: "Regen"+3', 'Pet: Damage taken -4%'}
    ...
    Pet_DT_legs = {
        name = "Acro Breeches",
        augments = {'Pet: DEF+25', 'Pet: "Regen"+3', 'Pet: Damage taken -4%'}
    }
    Pet_DT_feet = {
        name = "Acro Leggings",
        augments = {'Pet: DEF+25', 'Pet: "Regen"+3', 'Pet: Damage taken -4%'}
    ...
    Pet_Regen_head = {
        name = "Valorous Mask",
        augments = {'Pet: "Regen"+5', 'Pet: Accuracy+13 Pet: Rng. Acc.+13'}
    }
    Pet_Regen_body = {
        name = "Valorous Mail",
        augments = {'Pet: Accuracy+27 Pet: Rng. Acc.+27', 'Pet: "Regen"+5', 'Pet: Attack+4 Pet: Rng.Atk.+4'}
    }
    Pet_Regen_hands = {
        name = "Valorous Mitts",
        augments = {'Pet: Accuracy+29 Pet: Rng. Acc.+29', 'Pet: "Regen"+5', 'Pet: DEX+7',
                    'Pet: Attack+15 Pet: Rng.Atk.+15'}
    }
    Pet_Regen_legs = {
        name = "Valorous Hose",
        augments = {'Pet: "Regen"+5', 'Pet: Attack+1 Pet: Rng.Atk.+1'}
    }
    Pet_Regen_feet = "Emicho Gambieras +1"
    Pet_Regen_back = {
        name = "Artio's Mantle",
        augments = {'Pet: M.Acc.+20 Pet: M.Dmg.+20', 'Eva.+20 /Mag. Eva.+20', 'Pet: Mag. Acc.+10', 'Pet: "Regen"+10',
                    'Pet: "Regen"+5'}
    }
    ...
    Ready_Atk_body = {
        name = "Valorous Mail",
        augments = {'Pet: Attack+30 Pet: Rng.Atk.+30', 'Pet: STR+13'}
    }
    ...
    Ready_Atk_back = {
        name = "Artio's Mantle",
        augments = {'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20', 'Eva.+20 /Mag. Eva.+20',
                    'Pet: Attack+10 Pet: Rng.Atk.+10', 'Pet: Haste+10', 'System: 1 ID: 1246 Val: 4'}
    }
    ...
    Ready_Acc_back = {
        name = "Artio's Mantle",
        augments = {'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20', 'Eva.+20 /Mag. Eva.+20',
                    'Pet: Accuracy+10 Pet: Rng. Acc.+10', 'Pet: Haste+10', 'System: 1 ID: 1246 Val: 4'}
    }

    Ready_MAB_head = {
        name = "Valorous Mask",
        augments = {'Pet: "Mag.Atk.Bns."+30', 'Pet: "Store TP"+2', 'Pet: INT+8', 'Pet: Attack+6 Pet: Rng.Atk.+6'}
    }
    Ready_MAB_body = "Udug Jacket"
    Ready_MAB_hands = {
        name = "Valorous Mitts",
        augments = {'Pet: "Mag.Atk.Bns."+29', 'Pet: "Store TP"+9', 'Pet: INT+12', 'Pet: Attack+4 Pet: Rng.Atk.+4'}
    }
    Ready_MAB_legs = {
        name = "Valorous Hose",
        augments = {'Pet: "Mag.Atk.Bns."+30', 'Pet: INT+10', 'Pet: Accuracy+7 Pet: Rng. Acc.+7',
                    'Pet: Attack+6 Pet: Rng.Atk.+6'}
    }
    Ready_MAB_feet = {
        name = "Valorous Greaves",
        augments = {'Pet: "Mag.Atk.Bns."+30', 'Pet: INT+13', 'Pet: Accuracy+9 Pet: Rng. Acc.+9',
                    'Pet: Attack+15 Pet: Rng.Atk.+15'}
    }
    ...
    Ready_DA_body = {
        name = "Valorous Mail",
        augments = {'Pet: Mag. Acc.+27', 'Pet: "Dbl. Atk."+5', 'Pet: Accuracy+3 Pet: Rng. Acc.+3',
                    'Pet: Attack+15 Pet: Rng.Atk.+15'}
    }
    ...
    Ready_DA_feet = {
        name = "Valorous Greaves",
        augments = {'Pet: Mag. Acc.+20', 'Pet: "Dbl. Atk."+5', 'Pet: STR+9', 'Pet: Accuracy+13 Pet: Rng. Acc.+13',
    ...
    Pet_Melee_feet = {
        name = "Taeon Boots",
        augments = {'Pet: Attack+23 Pet: Rng.Atk.+23', 'Pet: "Dbl. Atk."+5', 'Pet: Damage taken -4%'}
    }
    ...
    Hybrid_legs = {
        name = "Taeon Tights",
        augments = {'Accuracy+20 Attack+20', '"Triple Atk."+2', 'Pet: Damage taken -4%'}
    }
    Hybrid_feet = {
        name = "Taeon Boots",
        augments = {'Accuracy+25', '"Triple Atk."+2', 'Pet: Damage taken -4%'}
    }

    DW_head = {
        name = "Taeon Chapeau",
        augments = {'Accuracy+19 Attack+19', '"Dual Wield"+5', 'STR+3 VIT+3'}
    }
    DW_body = {
        name = "Taeon Tabard",
        augments = {'Accuracy+20 Attack+20', '"Dual Wield"+5', 'Crit. hit damage +2%'}
    }
    DW_hands = "Emicho Gauntlets +1"
    DW_legs = {
        name = "Taeon Tights",
        augments = {'Accuracy+22', '"Dual Wield"+5', 'Crit. hit damage +2%'}
    }
    DW_feet = {
        name = "Taeon Boots",
        augments = {'Accuracy+23', '"Dual Wield"+5', 'Crit. hit damage +2%'}
    }
    DW_back = {
        name = "Artio's Mantle",
    ...
    MAB_head = {
        name = "Valorous Mask",
        augments = {'AGI+5', '"Mag.Atk.Bns."+25', 'Haste+2', 'Accuracy+19 Attack+19', 'Mag. Acc.+19 "Mag.Atk.Bns."+19'}
    }
    MAB_body = "Sacro Breastplate"
    MAB_hands = "Leyline Gloves"
    MAB_legs = {
        name = "Valorous Hose",
        augments = {'"Mag.Atk.Bns."+30', 'Accuracy+10', 'Crit.hit rate+2', 'Mag. Acc.+20 "Mag.Atk.Bns."+20'}
    }
    MAB_feet = {
        name = "Valorous Greaves",
        augments = {'CHR+8', '"Mag.Atk.Bns."+28', '"Refresh"+2', 'Accuracy+2 Attack+2', 'Mag. Acc.+14 "Mag.Atk.Bns."+14'}
    }
    ...
    MAcc_back = {
        name = "Artio's Mantle",
        augments = {'INT+20', 'Mag. Acc+20 /Mag. Dmg.+20', 'Mag. Acc.+10', 'Enmity+10', 'Phys. dmg. taken-10%'}
    }

    PDT_back = {
        name = "Artio's Mantle",
        augments = {'VIT+20', 'Eva.+20 /Mag. Eva.+20', 'VIT+10', 'Enmity-10', 'Phys. dmg. taken-10%'}
    }
    ...
    MEva_back = {
        name = "Artio's Mantle",
        augments = {'MND+20', 'Eva.+20 /Mag. Eva.+20', 'Mag. Evasion+10', 'Enmity-10',
                    'Occ. inc. resist. to stat. ailments+10'}
    }

    CB_head = {
        name = "Acro Helm",
        augments = {'Pet: Mag. Acc.+25', '"Call Beast" ability delay -5'}
    }
    ...
    Cure_Potency_feet = {
        name = "Taeon Boots",
        augments = {'"Cure" potency +5%'}
    }
    Cure_Potency_back = {
        name = "Artio's Mantle",
        augments = {'MND+20', 'Eva.+20 /Mag. Eva.+20', 'MND+10', '"Cure" potency +10%',
                    'Spell interruption rate down-10%'}
    }

    Waltz_back = {
        name = "Artio's Mantle",
        augments = {'CHR+20', 'Mag. Acc+20 /Mag. Dmg.+20', 'CHR+10', 'Weapon skill damage +10%'}
    }
    STP_back = {
        name = "Artio's Mantle",
    ...
    STP_head = {
        name = "Valorous Mask",
        augments = {'Attack+27', '"Store TP"+8', 'Accuracy+1'}
    }
    STP_feet = {
        name = "Valorous Greaves",
        augments = {'Accuracy+23 Attack+23', '"Store TP"+8', 'AGI+4'}
    }

    Regain_head = {
        name = "Valorous Mask",
        augments = {'"Cure" spellcasting time -7%', 'MND+8', 'Damage taken-4%', 'Mag. Acc.+15 "Mag.Atk.Bns."+15'}
    }
    ...
    TH_legs = {
        name = "Valorous Hose",
        augments = {'STR+3', 'INT+5', '"Treasure Hunter"+2', 'Mag. Acc.+18 "Mag.Atk.Bns."+18'}
    }

    Enmity_plus_feet = {
        name = "Acro Leggings",
        augments = {'Pet: Mag. Acc.+23', 'Enmity+10'}
    }
    Enmity_plus_back = {
        name = "Artio's Mantle",
        augments = {'INT+20', 'Mag. Acc+20 /Mag. Dmg.+20', 'Mag. Acc.+10', 'Enmity+10', 'Phys. dmg. taken-10%'}
    ...
    sets.precast.WS['Decimation'].Gavialis = set_combine(sets.precast.WS['Ruinator'], {
        head = "Gavialis Helm"
    })
    ...
    sets.precast.WS['Exenterator'].Gavialis = set_combine(sets.precast.WS['Exenterator'], {
        head = "Gavialis Helm"
    })
    ...
    sets.precast.WS['Entropy'].Gavialis = set_combine(sets.precast.WS['Entropy'], {
        head = "Gavialis Helm"
    })
...
function job_precast(spell, action, spellMap, eventArgs)
    ...
    if spell.english == 'Reward' then
        ...
        if state.AxeMode.value == 'PetOnly' then
            if player.sub_job == 'NIN' or player.sub_job == 'DNC' then
                equip({
                    ammo = RewardAmmo
                }, sets.precast.JA.RewardNEDW)
            else
                equip({
                    ammo = RewardAmmo
                }, sets.precast.JA.RewardNE)
            end
        else
            equip({
                ammo = RewardAmmo
    ...
    if spell.type == "WeaponSkill" and spell.name ~= 'Mistral Axe' and spell.name ~= 'Bora Axe' and
        spell.target.distance > target_distance then
        cancel_spell()
...
function get_custom_wsmode(spell, spellMap, default_wsmode)
    if default_wsmode == 'Normal' then
        if spell.english == "Ruinator" and
            (world.day_element == 'Water' or world.day_element == 'Wind' or world.day_element == 'Ice') then
            return 'Gavialis'
        end
...
function display_current_job_state(eventArgs)
    ...
    add_to_chat(28,
        'Ready Moves: 1.' .. ReadyMoveOne .. '  2.' .. ReadyMoveTwo .. '  3.' .. ReadyMoveThree .. '  4.' ..
            ReadyMoveFour .. '')
    add_to_chat(122, msg)
...
function equip_ready_gear(spell)
    ...
    if (physical_ready_moves:contains(spell.name) or magic_atk_ready_moves:contains(spell.name)) and
        state.OffenseMode.value ~= 'MaxAcc' then
...
function jug_pet_info()
    ...
    elseif state.JugMode.value == 'AmigoSabotender' or state.JugMode.value == 'Sun Water' then
        JugInfo = 'Sun Water'
    elseif state.JugMode.value == 'NurseryNazuna' or state.JugMode.value == 'Dancing Herbal Broth' or
        state.JugMode.value == 'D. Herbal Broth' then
        JugInfo = 'D. Herbal Broth'
    elseif state.JugMode.value == 'CraftyClyvonne' or state.JugMode.value == 'Cunning Brain Broth' or
        state.JugMode.value == 'Cng. Brain Broth' then
        JugInfo = 'Cng. Brain Broth'
    elseif state.JugMode.value == 'PrestoJulio' or state.JugMode.value == 'Chirping Grasshopper Broth' or
        state.JugMode.value == 'C. Grass Broth' then
        JugInfo = 'C. Grass Broth'
    elseif state.JugMode.value == 'SwiftSieghard' or state.JugMode.value == 'Mellow Bird Broth' or state.JugMode.value ==
        'Mlw. Bird Broth' then
        JugInfo = 'Mlw. Bird Broth'
    elseif state.JugMode.value == 'MailbusterCetas' or state.JugMode.value == 'Goblin Bug Broth' or state.JugMode.value ==
        'Gob. Bug Broth' then
    ...
    elseif state.JugMode.value == 'SlipperySilas' or state.JugMode.value == 'Wormy Broth' then
        JugInfo = 'Wormy Broth'
    elseif state.JugMode.value == 'LuckyLulush' or state.JugMode.value == 'Lucky Carrot Broth' or state.JugMode.value ==
        'L. Carrot Broth' then
    ...
    elseif state.JugMode.value == 'FatsoFargann' or state.JugMode.value == 'Curdled Plasma Broth' or state.JugMode.value ==
        'C. Plasma Broth' then
        JugInfo = 'C. Plasma Broth'
    elseif state.JugMode.value == 'FaithfulFalcorr' or state.JugMode.value == 'Lucky Broth' then
        JugInfo = 'Lucky Broth'
    elseif state.JugMode.value == 'BugeyedBroncha' or state.JugMode.value == 'Savage Mole Broth' or state.JugMode.value ==
        'Svg. Mole Broth' then
        JugInfo = 'Svg. Mole Broth'
    elseif state.JugMode.value == 'BloodclawShasra' or state.JugMode.value == 'Razor Brain Broth' or state.JugMode.value ==
        'Rzr. Brain Broth' then
        JugInfo = 'Rzr. Brain Broth'
    elseif state.JugMode.value == 'GorefangHobs' or state.JugMode.value == 'Burning Carrion Broth' then
        JugInfo = 'B. Carrion Broth'
    elseif state.JugMode.value == 'GooeyGerard' or state.JugMode.value == 'Cloudy Wheat Broth' or state.JugMode.value ==
        'Cl. Wheat Broth' then
    ...
    elseif state.JugMode.value == 'PonderingPeter' or state.JugMode.value == 'Viscous Broth' or state.JugMode.value ==
        'Vis. Broth' then
        JugInfo = 'Vis. Broth'
    elseif state.JugMode.value == 'SunburstMalfik' or state.JugMode.value == 'Shimmering Broth' then
        JugInfo = 'Shimmering Broth'
    elseif state.JugMode.value == 'AgedAngus' or state.JugMode.value == 'Fermented Broth' or state.JugMode.value ==
        'Ferm. Broth' then
        JugInfo = 'Ferm. Broth'
    ...
    elseif state.JugMode.value == 'AmiableRoche' or state.JugMode.value == 'Airy Broth' then
        JugInfo = 'Airy Broth'
    elseif state.JugMode.value == 'HeraldHenry' or state.JugMode.value == 'Translucent Broth' or state.JugMode.value ==
        'Trans. Broth' then
        JugInfo = 'Trans. Broth'
    ...
    elseif state.JugMode.value == 'CaringKiyomaro' or state.JugMode.value == 'Fizzy Broth' then
        JugInfo = 'Fizzy Broth'
    elseif state.JugMode.value == 'VivaciousVickie' or state.JugMode.value == 'Tantalizing Broth' or state.JugMode.value ==
        'Tant. Broth' then
        JugInfo = 'Tant. Broth'
    ...
    elseif state.JugMode.value == 'StalwartAngelin' or state.JugMode.value == 'Truly Pristine Sap' or
        state.JugMode.value == 'T. Pristine Sap' then
...
function pet_info_update()
    if pet.isvalid then
        ...
        if pet.name == 'DroopyDortwin' or pet.name == 'PonderingPeter' or pet.name == 'HareFamiliar' or pet.name ==
            'KeenearedSteffi' then
            PetInfo = "Rabbit, Beast";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Foot Kick';
            ReadyMoveTwo = 'Whirl Claws';
            ReadyMoveThree = 'Wild Carrot';
            ReadyMoveFour = 'Dust Cloud'
        elseif pet.name == 'LuckyLulush' then
            ...
            ReadyMoveTwo = 'Whirl Claws';
            ReadyMoveThree = 'Wild Carrot';
            ReadyMoveFour = 'Snow Cloud'
        elseif pet.name == 'SunburstMalfik' or pet.name == 'AgedAngus' or pet.name == 'HeraldHenry' or pet.name ==
            'CrabFamiliar' or pet.name == 'CourierCarrie' then
            PetInfo = "Crab, Aquan";
            PetJob = 'Paladin';
            ReadyMoveOne = 'Big Scissors';
            ReadyMoveTwo = 'Scissor Guard';
            ReadyMoveThree = 'Bubble Curtain';
            ReadyMoveFour = 'Metallic Body'
        elseif pet.name == 'P.CrabFamiliar' or pet.name == 'JovialEdwin' then
            PetInfo = "Barnacle Crab, Aquan";
            PetJob = 'Paladin';
            ReadyMoveOne = 'Mega Scissors';
            ReadyMoveTwo = 'Venom Shower';
            ReadyMoveThree = 'Bubble Curtain';
            ReadyMoveFour = 'Metallic Body'
        elseif pet.name == 'WarlikePatrick' or pet.name == 'LizardFamiliar' or pet.name == 'ColdbloodComo' or pet.name ==
            'AudaciousAnna' then
            PetInfo = "Lizard, Lizard";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Tail Blow';
            ReadyMoveTwo = 'Fireball';
            ReadyMoveThree = 'Brain Crush';
            ReadyMoveFour = 'Blockhead'
        elseif pet.name == 'ScissorlegXerin' or pet.name == 'BouncingBertha' then
            ...
            ReadyMoveFour = 'Tegmina Buffet'
        elseif pet.name == 'RhymingShizuna' or pet.name == 'SheepFamiliar' or pet.name == 'LullabyMelodia' or pet.name ==
            'NurseryNazuna' then
            PetInfo = "Sheep, Beast";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Sheep Charge';
            ReadyMoveTwo = 'Rage';
            ReadyMoveThree = 'Sheep Song';
            ReadyMoveFour = 'Lamb Chop'
        ...
        elseif pet.name == 'BrainyWaluis' or pet.name == 'FunguarFamiliar' or pet.name == 'DiscreetLouise' then
            ...
            ReadyMoveFour = 'Dark Spore'
        elseif pet.name == 'HeadbreakerKen' or pet.name == 'MayflyFamiliar' or pet.name == 'ShellbusterOrob' or pet.name ==
            'MailbusterCetas' then
            PetInfo = "Fly, Vermin";
            PetJob = 'Warrior';
        ...
        elseif pet.name == 'RedolentCandi' or pet.name == 'AlluringHoney' then
            ...
            ReadyMoveFour = 'Nepenthic Plunge'
        ...
        elseif pet.name == 'HurlerPercival' or pet.name == 'BeetleFamiliar' or pet.name == 'PanzerGalahad' then
            ...
            ReadyMoveFour = 'Rhino Guard'
        elseif pet.name == 'Y.BeetleFamilia' or pet.name == 'EnergizedSefina' then
            PetInfo = "Beetle (Horn), Vermin";
            PetJob = 'Paladin';
            ReadyMoveOne = 'Rhinowrecker';
            ReadyMoveTwo = 'Hi-Freq Field';
            ReadyMoveThree = 'Rhino Attack';
            ReadyMoveFour = 'Rhino Guard'
        elseif pet.name == 'BlackbeardRandy' or pet.name == 'TigerFamiliar' or pet.name == 'SaberSiravarde' or pet.name ==
            'GorefangHobs' then
            PetInfo = "Tiger, Beast";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Razor Fang';
            ReadyMoveTwo = 'Crossthrash';
            ReadyMoveThree = 'Roar';
            ReadyMoveFour = 'Predatory Glare'
        ...
        elseif pet.name == 'ThreestarLynn' or pet.name == 'DipperYuly' then
            ...
            ReadyMoveFour = 'Noisome Powder'
        elseif pet.name == 'SharpwitHermes' or pet.name == 'SweetCaroline' or pet.name == 'FlowerpotBill' or pet.name ==
            'FlowerpotBen' or pet.name == 'Homunculus' or pet.name == 'FlowerpotMerle' then
            PetInfo = "Mandragora, Plantoid";
            PetJob = 'Monk';
            ReadyMoveOne = 'Head Butt';
            ReadyMoveTwo = 'Leaf Dagger';
            ReadyMoveThree = 'Wild Oats';
            ReadyMoveFour = 'Scream'
        elseif pet.name == 'AcuexFamiliar' or pet.name == 'FluffyBredo' then
            ...
            ReadyMoveFour = 'Pestilent Plume'
        elseif pet.name == 'FlytrapFamiliar' or pet.name == 'VoraciousAudrey' or pet.name == 'PrestoJulio' then
            PetInfo = "Flytrap, Plantoid";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Soporific';
            ReadyMoveTwo = 'Palsy Pollen';
            ReadyMoveThree = 'Gloeosuccus';
            ReadyMoveFour = 'Gloeosuccus'
        elseif pet.name == 'EftFamiliar' or pet.name == 'AmbusherAllie' or pet.name == 'BugeyedBroncha' or pet.name ==
            'SuspiciousAlice' then
            PetInfo = "Eft, Lizard";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Nimble Snap';
            ReadyMoveTwo = 'Cyclotail';
            ReadyMoveThree = 'Geist Wall';
            ReadyMoveFour = 'Numbing Noise'
        ...
        elseif pet.name == 'Hip.Familiar' or pet.name == 'DaringRoland' or pet.name == 'FaithfulFalcorr' then
            ...
            PetJob = 'Thief';
            ReadyMoveOne = 'Hoof Volley';
            ReadyMoveTwo = 'Fantod';
            ReadyMoveThree = 'Nihility Song';
            ReadyMoveFour = 'Back Heel'
        ...
        elseif pet.name == 'MosquitoFamilia' or pet.name == 'Left-HandedYoko' then
            ...
            ReadyMoveFour = 'Gloom Spray'
        elseif pet.name == 'WeevilFamiliar' or pet.name == 'StalwartAngelin' then
            PetInfo = "Weevil, Vermin";
            PetJob = 'Thief';
            ReadyMoveOne = 'Disembowel';
            ReadyMoveTwo = 'Extirpating Salvo';
            ReadyMoveThree = 'Extirpating Salvo';
            ReadyMoveFour = 'Extirpating Salvo'
        elseif pet.name == 'SlimeFamiliar' or pet.name == 'SultryPatrice' then
            PetInfo = "Slime, Amorph";
            PetJob = 'Warrior';
            ReadyMoveOne = 'Fluid Toss';
            ReadyMoveTwo = 'Fluid Spread';
            ReadyMoveThree = 'Digest';
            ReadyMoveFour = 'Digest'
        end
    else
        PetName = 'None';
        PetJob = 'None';
