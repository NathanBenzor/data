...
state.WeaponMode = {}
state.WeaponMode = M {
    ['description'] = 'Weapon Specific Mode'
}
...
Elemental_WS = S {'Aeolian Edge', 'Seraph Blade', 'Shining Blade', 'Red Lotus Blade', 'Burning Blade', 'Sanguine Blade',
                  'Energy Drain', 'Energy Steal', 'Cyclone', 'Gust Slash', 'Leaden Salute', 'Wildfire', 'Earth Shot',
                  'Ice Shot', 'Water Shot', 'Fire Shot', 'Wind Shot', 'Thunder Shot'}

Geomancy_List = M('Geo-Acumen', 'Geo-Attunement', 'Geo-Barrier', 'Geo-STR', 'Geo-DEX', 'Geo-VIT', 'Geo-AGI', 'Geo-INT',
    'Geo-MND', 'Geo-CHR', 'Geo-Fade', 'Geo-Fend', 'Geo-Focus', 'Geo-Frailty', 'Geo-Fury', 'Geo-Gravity', 'Geo-Haste',
    'Geo-Languor', 'Geo-Malaise', 'Geo-Paralysis', 'Geo-Poison', 'Geo-Precision', 'Geo-Refresh', 'Geo-Regen',
    'Geo-Slip', 'Geo-Slow', 'Geo-Torpor', 'Geo-Vex', 'Geo-Voidance', 'Geo-Wilt')

Indicolure_List = M('Indi-Acumen', 'Indi-Attunement', 'Indi-Barrier', 'Indi-STR', 'Indi-DEX', 'Indi-VIT', 'Indi-AGI',
    'Indi-INT', 'Indi-MND', 'Indi-CHR', 'Indi-Fade', 'Indi-Fend', 'Indi-Focus', 'Indi-Frailty', 'Indi-Fury',
    'Indi-Gravity', 'Indi-Haste', 'Indi-Languor', 'Indi-Malaise', 'Indi-Paralysis', 'Indi-Poison', 'Indi-Precision',
    'Indi-Refresh', 'Indi-Regen', 'Indi-Slip', 'Indi-Slow', 'Indi-Torpor', 'Indi-Vex', 'Indi-Voidance', 'Indi-Wilt')

Enfeebling_Song = S {'Foe Requiem', 'Foe Requiem II', 'Foe Requiem III', 'Foe Requiem IV', 'Foe Requiem V',
                     'Foe Requiem VI', 'Foe Requiem VII', 'Battlefield Elegy', 'Carnage Elegy', 'Fire Threnody',
                     'Ice Threnody', 'Wind Threnody', 'Earth Threnody', 'Ltng. Threnody', 'Water Threnody',
                     'Light Threnody', 'Dark Threnody', 'Fire Threnody II', 'Ice Threnody II', 'Wind Threnody II',
                     'Earth Threnody II', 'Ltng. Threnody II', 'Water Threnody II', 'Light Threnody II',
                     'Dark Threnody II', 'Magic Finale', 'Pining Nocturne'}

Enfeeble_Acc = S {'Dispel', 'Aspir', 'Aspir II', 'Aspir III', 'Drain', 'Drain II', 'Drain III', 'Frazzle', 'Frazzle II',
                  'Stun', 'Poison', 'Poison II', 'Poisonga'}
Enfeeble_Potency = S {'Paralyze', 'Paralyze II', 'Slow', 'Slow II', 'Addle', 'Addle II', 'Distract', 'Distract II',
                      'Distract III', 'Frazzle III', 'Blind', 'Blind II'}
Enfeeble_Duration = S {'Sleep', 'Sleep II', 'Sleepga', 'Sleepga II', 'Diaga', 'Dia', 'Dia II', 'Dia III', 'Bio',
                       'Bio II', 'Bio III', 'Silence', 'Gravity', 'Gravity II', 'Inundation', 'Break', 'Breakaga',
                       'Bind', 'Bind II'}

Dark_Acc = S {'Death', 'Bio', 'Bio II', 'Bio III', 'Kaustra', 'Stun'}
Dark_Absorb = S {'Absorb-ACC', 'Absorb-AGI', 'Absorb-Attri', 'Absorb-CHR', 'Absorb-DEX', 'Absorb-INT', 'Absorb-MND',
                 'Absorb-STR', 'Absorb-TP', 'Absorb-VIT', 'Aspir', 'Aspir II', 'Aspir III', 'Drain', 'Drain II',
                 'Drain III'}
Dark_Enhancing = S {'Dread Spikes', 'Endark', 'Endark II', 'Klimaform', 'Tractor'}

Enhancing_Skill = S {'Temper', 'Temper II', 'Enaero', 'Enstone', 'Enthunder', 'Enwater', 'Enfire', 'Enblizzard',
                     'Boost-STR', 'Boost-DEX', 'Boost-VIT', 'Boost-AGI', 'Boost-INT', 'Boost-MND', 'Boost-CHR'}
Divine_Skill = S {'Enlight', 'Enlight II', 'Flash', 'Repose', 'Holy', 'Holy II', 'Banish', 'Banish II', 'Banish III',
...
BlueSkill = S {'Occultation', 'Erratic Flutter', 'Nature\'s Meditation', 'Cocoon', 'Barrier Tusk', 'Matellic Body',
               'Mighty Guard'}
...
Buff_BPs_Duration = S {'Shining Ruby', 'Aerial Armor', 'Frost Armor', 'Rolling Thunder', 'Crimson Howl',
                       'Lightning Armor', 'Ecliptic Growl', 'Glittering Ruby', 'Earthen Ward', 'Hastega', 'Noctoshield',
                       'Ecliptic Howl', 'Dream Shroud', 'Earthen Armor', 'Fleet Wind', 'Inferno Howl',
...
Debuff_BPs = S {'Mewing Lullaby', 'Eerie Eye', 'Lunar Cry', 'Lunar Roar', 'Nightmare', 'Pavor Nocturnus',
                'Ultimate Terror', 'Somnolence', 'Slowga', 'Tidal Roar', 'Diamond Storm', 'Sleepga', 'Shock Squall'}
Debuff_Rage_BPs = S {'Moonlit Charge', 'Tail Whip'}
Magic_BPs_NoTP = S {'Holy Mist', 'Nether Blast', 'Aerial Blast', 'Searing Light', 'Diamond Dust', 'Earthen Fury',
                    'Zantetsuken', 'Tidal Wave', 'Judgment Bolt', 'Inferno', 'Howling Moon', 'Ruinous Omen',
                    'Night Terror', 'Thunderspark'}
...
AvatarList = S {'Shiva', 'Ramuh', 'Garuda', 'Leviathan', 'Diabolos', 'Titan', 'Fenrir', 'Ifrit', 'Carbuncle',
                'Fire Spirit', 'Air Spirit', 'Ice Spirit', 'Thunder Spirit', 'Light Spirit', 'Dark Spirit',
                'Earth Spirit', 'Water Spirit', 'Cait Sith', 'Alexander', 'Odin', 'Atomos'}

SongCount = S {"Knight's Minne", "Knight's Minne II", "Army's Paeon", "Army's Paeon II", "Army's Paeon III",
               "Army's Paeon IV", "Fowl Aubade", "Herb Pastoral", "Shining Fantasia", "Scop's Operetta",
               "Puppet's Operetta", "Gold Capriccio", "Warding Round", "Goblin Gavotte"}

Enfeebling_Ninjitsu = S {'Jubaku: Ichi', 'Kurayami: Ni', 'Hojo: Ichi', 'Hojo: Ni', 'Kurayami: Ichi', 'Dokumori: Ichi',
                         'Aisha: Ichi', 'Yurin: Ichi'}

Elemental_Bar = S {'Barfire', 'Barblizzard', 'Baraero', 'Barstone', 'Barthunder', 'Barwater', 'Barfira', 'Barblizzara',
                   'Baraera', 'Barstonra', 'Barthundra', 'Barwatera'}
Status_Bar = S {'Barsleepra', 'Barpoisonra', 'Barparalyzra', 'Barblindra', 'Barvira', 'Barpetra', 'Baramnesra',
                'Barsilencera', 'Barsleep', 'Barpoison', 'Barparalyze', 'Barblind', 'Barvirus', 'Barpetrify',
                'Baramnesia', 'Barsilence'}

-- Standard Ready Moves
Ready_Standard = S {'Sic', 'Whirl Claws', 'Dust Cloud', 'Foot Kick', 'Sheep Song', 'Sheep Charge', 'Lamb Chop', 'Rage',
                    'Head Butt', 'Scream', 'Dream Flower', 'Wild Oats', 'Leaf Dagger', 'Claw Cyclone', 'Razor Fang',
                    'Roar', 'Gloeosuccus', 'Palsy Pollen', 'Soporific', 'Cursed Sphere', 'Venom', 'Geist Wall',
                    'Toxic Spit', 'Numbing Noise', 'Nimble Snap', 'Cyclotail', 'Spoil', 'Rhino Guard', 'Rhino Attack',
                    'Power Attack', 'Hi-Freq Field', 'Sandpit', 'Sandblast', 'Venom Spray', 'Mandibular Bite',
                    'Metallic Body', 'Bubble Shower', 'Bubble Curtain', 'Scissor Guard', 'Big Scissors', 'Grapple',
                    'Spinning Top', 'Double Claw', 'Filamented Hold', 'Frog Kick', 'Queasyshroom', 'Silence Gas',
                    'Numbshroom', 'Spore', 'Dark Spore', 'Shakeshroom', 'Blockhead', 'Secretion', 'Fireball',
                    'Tail Blow', 'Plague Breath', 'Brain Crush', 'Infrasonics', '??? Needles', 'Needleshot',
                    'Chaotic Eye', 'Blaster', 'Scythe Tail', 'Ripper Fang', 'Chomp Rush', 'Intimidate', 'Recoil Dive',
                    'Water Wall', 'Snow Cloud', 'Wild Carrot', 'Sudden Lunge', 'Spiral Spin', 'Noisome Powder',
                    'Wing Slap', 'Beak Lunge', 'Suction', 'Drainkiss', 'Acid Mist', 'TP Drainkiss', 'Back Heel',
                    'Jettatura', 'Choke Breath', 'Fantod', 'Charged Whisker', 'Purulent Ooze', 'Corrosive Ooze',
                    'Tortoise Stomp', 'Harden Shell', 'Aqua Breath', 'Sensilla Blades', 'Tegmina Buffet',
                    'Molting Plumage', 'Swooping Frenzy', 'Pentapeck', 'Sweeping Gouge', 'Zealous Snort', 'Somersault ',
                    'Tickling Tendrils', 'Stink Bomb', 'Nectarous Deluge', 'Nepenthic Plunge', 'Pecking Flurry',
                    'Pestilent Plume', 'Foul Waters', 'Spider Web', 'Sickle Slash', 'Crossthrash', 'Predatory Glare',
                    'Hoof Volley', 'Nihility Song', 'Frenzied Rage', 'Venom Shower', 'Mega Scissors', 'Fluid Toss',
...
Ready_Magic = S {'Dust Cloud', 'Sheep Song', 'Scream', 'Dream Flower', 'Roar', 'Gloeosuccus', 'Palsy Pollen',
                 'Soporific', 'Cursed Sphere', 'Venom', 'Geist Wall', 'Toxic Spit', 'Numbing Noise', 'Spoil',
                 'Hi-Freq Field', 'Sandpit', 'Sandblast', 'Venom Spray', 'Bubble Shower', 'Filamented Hold',
                 'Queasyshroom', 'Silence Gas', 'Numbshroom', 'Spore', 'Dark Spore', 'Shakeshroom', 'Fireball',
                 'Plague Breath', 'Infrasonics', 'Chaotic Eye', 'Blaster', 'Intimidate', 'Snow Cloud', 'Noisome Powder',
                 'TP Drainkiss', 'Jettatura', 'Charged Whisker', 'Purulent Ooze', 'Corrosive Ooze', 'Aqua Breath',
                 'Molting Plumage', 'Stink Bomb', 'Nectarous Deluge', 'Nepenthic Plunge', 'Pestilent Plume',
                 'Foul Waters', 'Spider Web'}

-- List of TP based Ready moves
Ready_TP = S {'Sic', 'Somersault', 'Dust Cloud', 'Foot Kick', 'Sheep Song', 'Sheep Charge', 'Lamb Chop', 'Rage',
              ...
              'Nimble Snap', 'Cyclotail', 'Spoil', 'Rhino Guard', 'Rhino Attack', 'Hi-Freq Field', 'Sandpit',
              'Sandblast', 'Mandibular Bite', 'Metallic Body', 'Bubble Shower', 'Bubble Curtain', 'Scissor Guard',
              'Grapple', 'Spinning Top', 'Double Claw', 'Filamented Hold', 'Spore', 'Blockhead', 'Secretion',
              'Fireball', 'Tail Blow', 'Plague Breath', 'Brain Crush', 'Infrasonics', 'Needleshot', 'Chaotic Eye',
              'Blaster', 'Ripper Fang', 'Intimidate', 'Recoil Dive', 'Water Wall', 'Snow Cloud', 'Wild Carrot',
              ...
              'Sweeping Gouge', 'Zealous Snort', 'Tickling Tendrils', 'Pecking Flurry', 'Pestilent Plume',
              'Foul Waters', 'Spider Web'}

-- Magic ACC Based Ready moves
Ready_Debuff = S {'Dust Cloud', 'Sheep Song', 'Scream', 'Dream Flower', 'Roar', 'Gloeosuccus', 'Palsy Pollen',
                  'Soporific', 'Geist Wall', 'Numbing Noise', 'Spoil', 'Hi-Freq Field', 'Sandpit', 'Sandblast',
                  'Filamented Hold', 'Spore', 'Fireball', 'Infrasonics', 'Chaotic Eye', 'Blaster', 'Intimidate',
                  'Noisome Powder', 'TP Drainkiss', 'Jettatura', 'Purulent Ooze', 'Corrosive Ooze', 'Pestilent Plume',
                  'Spider Web', 'Nihility Song'}
...
do
    ...
    local Storms = S {"Aurorastorm", "Voidstorm", "Firestorm", "Sandstorm", "Rainstorm", "Windstorm", "Hailstorm",
                      "Thunderstorm", "Aurorastorm II", "Voidstorm II", "Firestorm II", "Sandstorm II", "Rainstorm II",
                      "Windstorm II", "Hailstorm II", "Thunderstorm II"}

    local UtsusemiSpell = S {'Utsusemi: Ichi', 'Utsusemi: Ni', 'Utsusemi: San'}
    local RecastTimers = S {'WhiteMagic', 'BlackMagic', 'Ninjutsu', 'BlueMagic', 'BardSong', 'SummoningMagic',
                            'SummonerPact'}
    local SleepSongs = S {'Foe Lullaby', 'Foe Lullaby II', 'Horde Lullaby', 'Horde Lullaby II'}

    local Divergence_Zones = S {"Dynamis - San d'Oria [D]", "Dynamis - Bastok [D]", "Dynamis - Windurst [D]",
                                "Dynamis - Jeuno [D]"}
    ...
    local Cities = S {"Ru'Lude Gardens", "Upper Jeuno", "Lower Jeuno", "Port Jeuno", "Port Windurst", "Windurst Waters",
                      ...
                      "Metalworks", "Aht Urhgan Whitegate", "The Colosseum", "Tavnazian Safehold", "Nashmau", "Selbina",
                      "Mhaura", "Rabao", "Norg", "Kazham", "Eastern Adoulin", "Western Adoulin",
    ...
    local skillchains = {
        [288] = {
            id = 288,
            english = 'Light',
            elements = {'Light', 'Lightning', 'Wind', 'Fire'}
        },
        [289] = {
            id = 289,
            english = 'Darkness',
            elements = {'Dark', 'Ice', 'Water', 'Earth'}
        },
        [290] = {
            id = 290,
            english = 'Gravitation',
    ...
    function display_box_update()
        ...
        dialog[1] = {
            description = 'Stance',
            value = state.OffenseMode.value
        }
        dialog[2] = {
            description = 'TH Mode',
            value = state.TreasureMode.value
        }
        dialog[3] = {
            description = 'Auto Buff',
            value = state.AutoBuff.value
        }
        dialog[4] = {
            description = 'DPS',
            value = state.WeaponMode.value
        }
        if UI_Name ~= "" then
            dialog[5] = {
                description = UI_Name,
                value = state.JobMode.value
            }
        end
        if UI_Name2 ~= "" then
            dialog[6] = {
                description = UI_Name2,
                value = state.JobMode2.value
            }
        end
        local lines = T {}
        for k, v in next, dialog do
            lines:insert(v.description ..
                             string.format('[%s]', tostring(v.value)):lpad(' ',
                    width - string.len(tostring(v.description))))
        end
        local maxWidth = math.max(1, table.reduce(lines, function(a, b)
            return math.max(a, #b)
        end, '1'))
        -- Pad each entry
    ...
    function pretargetcheck(spell, action)
        ...
        elseif spell.type == 'JobAbility' or spell.type == 'BloodPactWard' or spell.type == 'BloodPactRage' or
            spell.type == 'PetCommand' then
        ...
        elseif RecastTimers:contains(spell.type) then
            ...
            elseif spell.target.type then
                ...
                elseif tostring(cast_spell.targets) == '{Enemy}' then
                    if spell.target.type ~= 'MONSTER' and not spell.name:contains('Lullaby') and
                        not spell.name:contains('Sleep') then
                        -- Cancel Spell
                    ...
                    -- Party Buffs
                elseif tostring(cast_spell.targets) == '{Self, Party}' or tostring(cast_spell.targets) ==
                    '{Self, Party, Ally, NPC}' then
    ...
    function precastequip(spell)
        ...
        if spell.type == 'WeaponSkill' then
            ...
            if spell.skill == "Marksmanship" or spell.skill == "Archery" then
                ...
                if built_set[spell.english] then
                    ...
                    if buffactive['Aftermath: Lv.3'] and sets.WS.AM3 and sets.WS.AM3.RA and
                        sets.WS.AM3.RA[state.WeaponMode.value] then
                        built_set = set_combine(built_set, sets.WS.AM3.RA[state.WeaponMode.value])
                        message = '[' .. spell.english .. '] Set with Aftermath 3 (Ranged)'
                    elseif buffactive['Aftermath: Lv.2'] and sets.WS.AM2 and sets.WS.AM2.RA and
                        sets.WS.AM2.RA[state.WeaponMode.value] then
                        built_set = set_combine(built_set, sets.WS.AM2.RA[state.WeaponMode.value])
                        message = '[' .. spell.english .. '] Set with Aftermath 2 (Ranged)'
                    elseif buffactive['Aftermath: Lv.1'] and sets.WS.AM1 and sets.WS.AM1.RA and
                        sets.WS.AM1.RA[state.WeaponMode.value] then
                        built_set = set_combine(built_set, sets.WS.AM1.RA[state.WeaponMode.value])
                        message = '[' .. spell.english .. '] Set with Aftermath 1 (Ranged)'
                    elseif buffactive['Aftermath'] and sets.WS.AM and sets.WS.AM.RA and
                        sets.WS.AM.RA[state.WeaponMode.value] then
        ...
        elseif spell.type == 'Ninjutsu' then
            ...
            elseif UtsusemiSpell:contains(spell.name) then
                built_set =
                    set_combine(built_set, sets.Precast.FastCast, sets.Precast.QuickMagic, sets.Precast.Utsusemi)
        ...
        elseif spell.type == 'BardSong' then
            ...
            if not buffactive['Nightingale'] then
                ...
                if SongCount:contains(spell.name) then
                    built_set = set_combine(built_set, sets.Precast.FastCast, sets.Precast.Songs, {
                ...
                if SongCount:contains(spell.name) then
                    ...
                    built_set = set_combine(sets.Midcast, sets.Midcast.DummySongs, {
                        range = Instrument.Count
                    })
                    -- Equip Marsyas
                elseif spell.name == "Honor March" then
                    built_set = set_combine(sets.Midcast, equip_song_gear(spell), {
                        range = Instrument.Honor
                    })
                    -- Equip Loughnashade
                elseif spell.name == "Aria of Passion" then
                ...
                elseif spell.name:contains('Horde') then
                    ...
                    built_set = set_combine(sets.Midcast, sets.Midcast.Enfeebling, equip_song_gear(spell), {
        ...
        if state.TreasureMode.value ~= 'None' and spell.target.type == 'MONSTER' and
            not th_info.tagged_mobs[spell.target.id] then
            built_set = set_combine(built_set, sets.TreasureHunter)
        end
    ...
    function midcastequip(spell)
        ...
        if spell.action_type == 'Ranged Attack' then
            ...
            -- Check if Aftermath is active
            if buffactive['Aftermath: Lv.3'] and sets.Midcast.AM3 and sets.Midcast.AM3.RA and
                sets.Midcast.AM3.RA[state.WeaponMode.value] then
                built_set = set_combine(built_set, sets.Midcast.AM3.RA[state.WeaponMode.value])
                message = '[' .. spell.english .. '] Set with Aftermath 3 (Ranged)'
            elseif buffactive['Aftermath: Lv.2'] and sets.Midcast.AM2 and sets.Midcast.AM2.RA and
                sets.Midcast.AM2.RA[state.WeaponMode.value] then
                built_set = set_combine(built_set, sets.Midcast.AM2.RA[state.WeaponMode.value])
                message = '[' .. spell.english .. '] Set with Aftermath 2 (Ranged)'
            elseif buffactive['Aftermath: Lv.1'] and sets.Midcast.AM1 and sets.Midcast.AM1.RA and
                sets.Midcast.AM1.RA[state.WeaponMode.value] then
                built_set = set_combine(built_set, sets.Midcast.AM1.RA[state.WeaponMode.value])
                message = '[' .. spell.english .. '] Set with Aftermath 1 (Ranged)'
            elseif buffactive['Aftermath'] and sets.Midcast.AM and sets.Midcast.AM.RA and
                sets.Midcast.AM.RA[state.WeaponMode.value] then
        ...
        elseif spell.type == 'WhiteMagic' then
            ...
            elseif spell.name:contains('Regen') then
                if spell.target.type == 'SELF' then
                    ...
                    built_set = set_combine(built_set, sets.Midcast.SIRD, sets.Midcast.Enhancing.Others,
                        sets.Midcast.Regen)
        ...
        elseif spell.type == 'BlackMagic' then
            ...
            elseif spell.skill == 'Dark Magic' then
                ...
                elseif Dark_Enhancing:contains(spell.name) then
                    ...
                    built_set =
                        set_combine(built_set, sets.Midcast.SIRD, sets.Midcast.Dark, sets.Midcast.Dark.Enhancing)
                else
                    info('Dark Magic Set')
        ...
        elseif spell.type == 'BardSong' and not buffactive['Nightingale'] then
            ...
            elseif spell.name:contains('Horde') then
                info('[' .. spell.english .. '] Set (AOE Sleep)')
                built_set = set_combine(built_set, sets.Midcast.Enfeebling, equip_song_gear(spell), {
                    range = Instrument.AOE_Sleep
                })
                -- Normal Enfeebles
            elseif Enfeebling_Song:contains(spell.english) then
    ...
    function check_equipment_spells(spell)
        ...
        if spell.name == "Impact" then
            local Crepuscular = player.inventory["Crepuscular Cloak"] or player.wardrobe["Crepuscular Cloak"] or
                                    player.wardrobe2["Crepuscular Cloak"] or player.wardrobe3["Crepuscular Cloak"] or
                                    player.wardrobe4["Crepuscular Cloak"] or player.wardrobe5["Crepuscular Cloak"] or
                                    player.wardrobe6["Crepuscular Cloak"] or player.wardrobe7["Crepuscular Cloak"] or
                                    player.wardrobe8["Crepuscular Cloak"]

            local Twilight = player.inventory["Twilight Cloak"] or player.wardrobe["Twilight Cloak"] or
                                 player.wardrobe2["Twilight Cloak"] or player.wardrobe3["Twilight Cloak"] or
                                 player.wardrobe4["Twilight Cloak"] or player.wardrobe5["Twilight Cloak"] or
                                 player.wardrobe6["Twilight Cloak"] or player.wardrobe7["Twilight Cloak"] or
    ...
    function check_buff()
        ...
        if not is_Busy and state.AutoBuff.value ~= 'OFF' and not Cities:contains(world.area) and not buffactive['Stun'] and
            not buffactive['Terror'] then
            -- Set defaults
            command_JA = 'None'
            command_SP = 'None'
    ...
    function do_bullet_checks(spell, built_set)
        if spell and built_set then
            ...
            local available_bullets = player.inventory[bullet_name] or player.wardrobe[bullet_name] or
                                          player.wardrobe2[bullet_name] or player.wardrobe3[bullet_name] or
                                          player.wardrobe4[bullet_name] or player.wardrobe5[bullet_name] or
                                          player.wardrobe6[bullet_name] or player.wardrobe7[bullet_name] or
            ...
            if spell.type ~= 'CorsairShot' and bullet_name == Ammo.Bullet.QD and available_bullets.count <=
                bullet_min_count then
            ...
            -- Low ammo warning.
            if spell.type ~= 'CorsairShot' and state.warned.value == false and available_bullets.count > 1 and
                available_bullets.count <= Ammo_Warning_Limit then
    ...
    function self_command(cmd)
        ...
        elseif command == 'cp' then
            ...
            -- Reraise Item
        elseif command == 'rr' then
            use_enchantment("Airmid's Gorget")
        ...
        elseif command:contains('profile') then
            ...
            windower.send_command('exec ' .. smModePath .. '/' .. player.main_job .. '_' .. player.sub_job .. '_' ..
                                      player.name)
    ...
    function jobsetup(LockStylePallet, MacroBook, MacroSet)
        ...
        windower.send_command('wait 10;gs c two_hand_check;input /lockstyleset ' .. LockStylePallet ..
                                  ';wait 1;input /macro book ' .. MacroBook .. ';wait 1;input /macro set ' .. MacroSet ..
                                  ';gs validate;gs c update auto;wait 2;input /echo Change Complete')
    ...
    function two_hand_check()
        if sets.Weapons[state.WeaponMode.value] and sets.Weapons[state.WeaponMode.value]['main'] then
            ...
            if type(weapon_name) == "table" then
                weapon_name = sets.Weapons[state.WeaponMode.value]['main'].name
            end
            local Main_Weapon = res.items:with('en', weapon_name)
            if Main_Weapon then
                log('Weapon:[' .. Main_Weapon.en .. ']')
                local Skill_type = Main_Weapon.skill
                if Skill_type == 4 or Skill_type == 6 or Skill_type == 7 or Skill_type == 8 or Skill_type == 10 or
                    Skill_type == 12 then
                    TwoHand = true
                else
                    TwoHand = false
        ...
        if id == 0x29 and state.TreasureMode.value ~= 'None' then
            ...
            if th_info.tagged_mobs[target_id] then
                ...
                if message_id == 6 or message_id == 20 then
                    if settings.debug then
                        add_to_chat(123, 'Mob ' .. target_id .. ' died. Removing from tagged mobs table.')
                    end
    ...
    function on_zone_change_for_th(new_zone, old_zone)
        Unlock()
        if settings.debug then
            windower.add_to_chat(123, 'Zoning. Clearing tagged mobs table.')
        end
    ...
    function cleanup_tagged_mobs()
        ...
        for target_id, action_time in pairs(th_info.tagged_mobs) do
            ...
            if time_since_last_action > 180 then
                ...
                if settings.debug then
                    windower.add_to_chat(123, 'Over 3 minutes since last action on mob ' .. target_id ..
                        '. Removing from tagged mobs list.')
                end
            end
        end
    ...
    function elemental_check(spell)
        ...
        if (Elemental_WS:contains(spell.name) and spell.type == 'WeaponSkill') or spell.type == 'BlackMagic' then
            ...
            elseif spell.element == world.day_element and spell.element == world.weather_element then
                ...
                windower.add_to_chat(8, '[' .. world.day_element .. '] day and weather is [' .. world.weather_element ..
                    '] - using Hachirin-no-Obi')
    ...
    function main_engine()
        ...
        if now - main_engine_time < .1 then
            return
        end
        ...
        if not player or player.status == "Dead" or player.status == "Engaged dead" then
            return
        end

        -- Status Ailment Check
        if not buffactive['Paralysis'] and not buffactive['Silence'] and not buffactive['Sleep'] and
            not buffactive['Muddle'] then
            check_buff()
        end
    ...
    windower.register_event('lose buff', function(id)
        ...
        if id == 15 then -- Doom
            if Divergence_Zones:contains(world.area) then
                ...
                enable('main', 'sub', 'range', 'ammo', 'head', 'lear', 'rear', 'body', 'hands', 'lring', 'rring',
                    'waist', 'legs', 'feet')
            else
                Unlock()
            end
            ...
            if data.actor_id == player.id then
                ...
                elseif data.category == 9 then
                    ...
                    elseif data.param == 28787 then
                        ...
                        if Divergence_Zones:contains(world.area) then
                            enable('range', 'ammo', 'head', 'lear', 'rear', 'body', 'hands', 'lring', 'rring', 'waist',
                                'legs', 'feet')
                        else
                            Unlock()
                        end
    ...
    function choose_set()
        ...
        -- Combat Checks
        if player.status == "Engaged" then
            built_set = set_combine(built_set, sets.OffenseMode, sets.OffenseMode[state.OffenseMode.value],
                sets.Weapons[state.WeaponMode.value])
            ...
            elseif buffactive['Aftermath: Lv.2'] and sets.OffenseMode.AM2 and
                sets.OffenseMode.AM2[state.WeaponMode.value] then
                built_set = set_combine(built_set, sets.OffenseMode.AM2[state.WeaponMode.value])

            elseif buffactive['Aftermath: Lv.1'] and sets.OffenseMode.AM1 and
                sets.OffenseMode.AM1[state.WeaponMode.value] then
            ...
            if state.TreasureMode.value ~= 'None' then
                ...
                elseif state.TreasureMode.value == 'SATA' and
                    (buffactive['Sneak Attack'] or buffactive['Trick Attack'] or buffactive['Feint']) then
                    built_set = set_combine(built_set, sets.TreasureHunter)
                end
            end
            ...
            built_set = set_combine(built_set, sets.Idle, sets.Idle[state.OffenseMode.value],
                sets.Weapons[state.WeaponMode.value])
    ...
    function validate_sets()
        ...
        if not sets.Weapons.Sleep then
            sets.Weapons.Sleep = {}
        end
        if not sets.Weapons.Shield then
            sets.Weapons.Shield = {}
        end
        if not sets.Weapons.Songs then
            sets.Weapons.Songs = {}
        end
        if not sets.Weapons.Songs.Midcast then
            sets.Weapons.Songs.Midcast = {}
        end
        ...
        if not sets.Precast.FastCast then
            sets.Precast.FastCast = {}
        end
        if not sets.Precast.FastCast.Enhancing then
            sets.Precast.FastCast.Enhancing = {}
        end
        if not sets.Precast.Cure then
            sets.Precast.Cure = {}
        end
        if not sets.Precast.QuickMagic then
            sets.Precast.QuickMagic = {}
        end
        if not sets.Precast.Utsusemi then
            sets.Precast.Utsusemi = {}
        end
        if not sets.Precast.Songs then
            sets.Precast.Songs = {}
        end

        if not sets.Precast.RA then
            sets.Precast.RA = {}
        end
        if not sets.Precast.RA.Flurry then
            sets.Precast.RA.Flurry = {}
        end
        if not sets.Precast.RA.Flurry_II then
            sets.Precast.RA.Flurry_II = {}
        end
        ...
        if not sets.WS.ACC then
            sets.WS.ACC = {}
        end
        if not sets.WS.ACC.RA then
            sets.WS.ACC.RA = {}
        end
        if not sets.WS.PDL then
            sets.WS.PDL = {}
        end
        if not sets.WS.PDL.RA then
            sets.WS.PDL.RA = {}
        end
        if not sets.WS.SB then
            sets.WS.SB = {}
        end
        if not sets.WS.SB.RA then
            sets.WS.SB.RA = {}
        end
        if not sets.WS.CRIT then
            sets.WS.CRIT = {}
        end
        if not sets.WS.CRIT.RA then
            sets.WS.CRIT.RA = {}
        end
        if not sets.WS.MEVA then
            sets.WS.MEVA = {}
        end
        if not sets.WS.MEVA.RA then
            sets.WS.MEVA.RA = {}
        end
        if not sets.WS.AM then
            sets.WS.AM = {}
        end
        if not sets.WS.AM.RA then
            sets.WS.AM.RA = {}
        end
        if not sets.WS.AM1 then
            sets.WS.AM1 = {}
        end
        if not sets.WS.AM1.RA then
            sets.WS.AM1.RA = {}
        end
        if not sets.WS.AM2 then
            sets.WS.AM2 = {}
        end
        if not sets.WS.AM2.RA then
            sets.WS.AM2.RA = {}
        end
        if not sets.WS.AM3 then
            sets.WS.AM3 = {}
        end
        if not sets.WS.AM3.RA then
            sets.WS.AM3.RA = {}
        end
        ...
        if not sets.Midcast.RA then
            sets.Midcast.RA = {}
        end
        if not sets.Midcast.RA.ACC then
            sets.Midcast.RA.ACC = {}
        end
        if not sets.Midcast.RA.PDL then
            sets.Midcast.RA.PDL = {}
        end
        if not sets.Midcast.RA.SB then
            sets.Midcast.RA.SB = {}
        end
        if not sets.Midcast.RA.CRIT then
            sets.Midcast.RA.CRIT = {}
        end
        if not sets.Midcast.RA['True Shot'] then
            sets.Midcast.RA['True Shot'] = {}
        end
        if not sets.Midcast.RA.TripleShot then
            sets.Midcast.RA.TripleShot = {}
        end
        if not sets.Midcast.RA.DoubleShot then
            sets.Midcast.RA.DoubleShot = {}
        end
        if not sets.Midcast.RA.Barrage then
            sets.Midcast.RA.Barrage = {}
        end

        if not sets.Midcast.Enfeebling then
            sets.Midcast.Enfeebling = {}
        end
        if not sets.Midcast.Enfeebling.MACC then
            sets.Midcast.Enfeebling.MACC = {}
        end
        if not sets.Midcast.Enfeebling.Potency then
            sets.Midcast.Enfeebling.Potency = {}
        end
        if not sets.Midcast.Enfeebling.Duration then
            sets.Midcast.Enfeebling.Duration = {}
        end

        -- Midcast for Ranged Attacks and Aftermath
        if not sets.Midcast.AM then
            sets.Midcast.AM = {}
        end
        if not sets.Midcast.AM.RA then
            sets.Midcast.AM.RA = {}
        end
        if not sets.Midcast.AM1 then
            sets.Midcast.AM1 = {}
        end
        if not sets.Midcast.AM1.RA then
            sets.Midcast.AM1.RA = {}
        end
        if not sets.Midcast.AM2 then
            sets.Midcast.AM2 = {}
        end
        if not sets.Midcast.AM2.RA then
            sets.Midcast.AM2.RA = {}
        end
        if not sets.Midcast.AM3 then
            sets.Midcast.AM3 = {}
        end
        if not sets.Midcast.AM3.RA then
            sets.Midcast.AM3.RA = {}
        end

        if not sets.Midcast.SIRD then
            sets.Midcast.SIRD = {}
        end
        if not sets.Midcast.Nuke then
            sets.Midcast.Nuke = {}
        end
        if not sets.Midcast.Burst then
            sets.Midcast.Burst = {}
        end
        if not sets.Midcast.Cure then
            sets.Midcast.Cure = {}
        end
        if not sets.Midcast.Curaga then
            sets.Midcast.Curaga = {}
        end
        if not sets.Midcast.Cura then
            sets.Midcast.Cura = {}
        end
        if not sets.Midcast.Regen then
            sets.Midcast.Regen = {}
        end
        if not sets.Midcast.AM then
            sets.Midcast.Refresh = {}
        end
        if not sets.Midcast.Enhancing then
            sets.Midcast.Enhancing = {}
        end
        if not sets.Midcast.Enhancing.Others then
            sets.Midcast.Enhancing.Others = {}
        end
        if not sets.Midcast.Enhancing.Gain then
            sets.Midcast.Enhancing.Gain = {}
        end
        if not sets.Midcast.Enhancing.Elemental then
            sets.Midcast.Enhancing.Elemental = {}
        end
        if not sets.Midcast.Enhancing.Status then
            sets.Midcast.Enhancing.Status = {}
        end
        if not sets.Midcast.Enhancing.Skill then
            sets.Midcast.Enhancing.Skill = {}
        end

        if not sets.Midcast.Aspir then
            sets.Midcast.Aspir = {}
        end
        if not sets.Midcast.Drain then
            sets.Midcast.Drain = {}
        end
        if not sets.Midcast.Dark then
            sets.Midcast.Dark = {}
        end
        if not sets.Midcast.Dark.MACC then
            sets.Midcast.Dark.MACC = {}
        end
        if not sets.Midcast.Dark.Absorb then
            sets.Midcast.Dark.Absorb = {}
        end
        if not sets.Midcast.Dark.Enhancing then
            sets.Midcast.Dark.Enhancing = {}
        end
        if not sets.Midcast.Skill then
            sets.Midcast.Skill = {}
        end
        if not sets.Midcast.ACC then
            sets.Midcast.ACC = {}
        end
        if not sets.Midcast.BP then
            sets.Midcast.BP = {}
        end
        if not sets.Midcast.SummoningMagic then
            sets.Midcast.SummoningMagic = {}
        end
        if not sets.Midcast.Summon then
            sets.Midcast.Summon = {}
        end

        -- Bard Midcast
        if not sets.Midcast.DummySongs then
            sets.Midcast.DummySongs = {}
        end
        if not sets.Midcast.Finale then
            sets.Midcast.Finale = {}
        end
        if not sets.Midcast.Lullaby then
            sets.Midcast.Lullaby = {}
        end
        if not sets.Midcast.Threnody then
            sets.Midcast.Threnody = {}
        end
        if not sets.Midcast.Elegy then
            sets.Midcast.Elegy = {}
        end
        if not sets.Midcast.Requiem then
            sets.Midcast.Requiem = {}
        end
        if not sets.Midcast.March then
            sets.Midcast.March = {}
        end
        if not sets.Midcast.Minuet then
            sets.Midcast.Minuet = {}
        end
        if not sets.Midcast.Madrigal then
            sets.Midcast.Madrigal = {}
        end
        if not sets.Midcast.Ballad then
            sets.Midcast.Ballad = {}
        end
        if not sets.Midcast.Scherzo then
            sets.Midcast.Scherzo = {}
        end
        if not sets.Midcast.Mazurka then
            sets.Midcast.Mazurka = {}
        end
        if not sets.Midcast.Paeon then
            sets.Midcast.Paeon = {}
        end
        if not sets.Midcast.Carol then
            sets.Midcast.Carol = {}
        end
        if not sets.Midcast.Minne then
            sets.Midcast.Minne = {}
        end
        if not sets.Midcast.Mambo then
            sets.Midcast.Mambo = {}
        end
        if not sets.Midcast.Etude then
            sets.Midcast.Etude = {}
        end
        if not sets.Midcast.Prelude then
            sets.Midcast.Prelude = {}
        end
        if not sets.Midcast.Dirge then
            sets.Midcast.Dirge = {}
        end
        if not sets.Midcast.Sirvente then
            sets.Midcast.Sirvente = {}
        end
        if not sets.Midcast.Aria then
            sets.Midcast.Aria = {}
        end
        ...
        if not sets.Idle.Pet then
            sets.Idle.Pet = {}
        end
        if not sets.Idle.Sublimation then
            sets.Idle.Sublimation = {}
        end
        if not sets.Idle.Resting then
            sets.Idle.Resting = {}
        end
        if not sets.OffenseMode then
            sets.OffenseMode = {}
        end
        if not sets.OffenseMode.Ranged then
            sets.OffenseMode.Ranged = {}
        end
        if not sets.OffenseMode.AM then
            sets.OffenseMode.AM = {}
        end
        if not sets.OffenseMode.AM1 then
            sets.OffenseMode.AM1 = {}
        end
        if not sets.OffenseMode.AM2 then
            sets.OffenseMode.AM2 = {}
        end
        if not sets.OffenseMode.AM3 then
            sets.OffenseMode.AM3 = {}
        end
        ...
        if not sets.Waltz then
            sets.Waltz = {}
        end
        if not sets.Jig then
            sets.Jig = {}
        end
        if not sets.Samba then
            sets.Samba = {}
        end
        if not sets.Step then
            sets.Step = {}
        end
        if not sets.Flourish then
            sets.Flourish = {}
        end
        if not sets.Jugs then
            sets.Jugs = {}
        end
        if not sets.PhantomRoll then
            sets.PhantomRoll = {}
        end
        if not sets.TreasureHunter then
            sets.TreasureHunter = {}
        end
        if not sets.QuickDraw then
            sets.QuickDraw = {}
        end

        if not sets.Storms then
            sets.Storms = {}
        end
        if not sets.Enmity then
            sets.Enmity = {}
        end
        if not sets.Diffusion then
            sets.Diffusion = {}
        end
        if not sets.Geomancy then
            sets.Geomancy = {}
        end
        if not sets.Geomancy.Geo then
            sets.Geomancy.Geo = {}
        end
        if not sets.Geomancy.Indi then
            sets.Geomancy.Indi = {}
        end
        if not sets.Geomancy.Entrust then
            sets.Geomancy.Indi.Entrust = {}
        end
        if not sets.Pet_Midcast then
            sets.Pet_Midcast = {}
        end
        if not sets.DualWield then
            sets.DualWield = {}
        end
        if not sets.Cursna_Received then
            sets.Cursna_Received = {}
        end
        if not sets.Movement then
            sets.Movement = {}
        end
    end
