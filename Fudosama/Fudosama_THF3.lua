...
function user_setup()
    ...
    send_command(
        'bind ^numpad+ input //get Warp Ring satchel; wait 1; input /equip Ring1 "Warp Ring"; wait 12; input /item "Warp Ring" <me>; wait 60; input //put Warp Ring satchel')
    send_command(
        'bind !numpad+ input //get Dim. Ring (Dem) satchel; wait 1; input /equip Ring1 "Dim. Ring (Dem)"; wait 12; input /item "Dim. Ring (Dem)" <me>; wait 60; input //put Dim. Ring (Dem) satchel')
...
function init_gear_sets()
    ...
    sets.TreasureHunter = {
        ...
        sub = {
            name = "Taming Sari",
            augments = {'STR+1', '"Treasure Hunter"+1'}
        },
        ammo = "Per. Lucky Egg",
        head = {
            name = "Herculean Helm",
            augments = {'Pet: "Regen"+1', 'STR+5', '"Treasure Hunter"+1', 'Accuracy+17 Attack+17',
        ...
        back = {
            name = "Canny Cape",
            augments = {'DEX+3', 'AGI+2', '"Dual Wield"+3'}
        }
    }
