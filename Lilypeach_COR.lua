...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'DeathPenalty_M', 'DeathPenalty_R', 'Armageddon_M', 'Armageddon_R', 'Fomalhaut_M', 'Fomalhaut_R', 'Ataktos', 'Ataktos_Acc'}
...
function init_gear_sets()
    ...
    head={ name="Herculean Helm", augments={'Mag. Acc.+21','Weapon skill damage +4%','MND+2','"Mag.Atk.Bns."+13',}},
    body="Dread Jupon",
    hands={ name="Leyline Gloves", augments={'Accuracy+10','Mag. Acc.+7','"Fast Cast"+1',}},
    legs={ name="Herculean Trousers", augments={'Pet: "Store TP"+2','"Fast Cast"+2','Magic Damage +10','Accuracy+13 Attack+13','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
    ...
    hands="Lanun Gants +3", --8/11
    legs="Oshosi Trousers", --10/0
    feet="Meg. Jam. +2", --8/0
    waist="Yemaya Belt", --0/5
	ring2="Crepuscular Ring",
    back={ name="Camulus's Mantle", augments={'INT+20','Eva.+20 /Mag. Eva.+20','"Snapshot"+10',}}, --10/0
        } --58/30

    sets.precast.RA.Flurry = set_combine(sets.precast.RA, {body="Laksa. Frac +3",})
    sets.precast.RA.Flurry2 = set_combine(sets.precast.RA, {head="Chasseur's Tricorne +3",body="Laksa. Frac +3",})
  ...
  --  range={ name="Compensator", augments={'DMG:+9','AGI+9','Rng.Acc.+9',}},
  --  ammo="Iron Bullet",
	...
	sets.precast.WS['Leaden Salute'].Acc = set_combine(sets.precast.WS['Wildfire'], {
	        head="Pixie Hairpin +1",
			ear2={ name="Moonshade Earring", augments={'"Mag.Atk.Bns."+4','TP Bonus +250',}},
	...
	sets.precast.MaxTP = {ear2="Hecate's Earring"}
    ...
    feet={ name="Herculean Boots", augments={'Attack+29','"Triple Atk."+3','STR+7','Accuracy+14',}},
    neck="Iskur Gorget",
    waist="Reiki Yotai", --7 
    ...
    head={ name="Adhemar Bonnet +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    body={ name="Herculean Vest", augments={'Accuracy+26','"Triple Atk."+4','DEX+10','Attack+3',}},
    hands={ name="Adhemar Wrist. +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    legs={ name="Carmine Cuisses +1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}},
    feet={ name="Herculean Boots", augments={'Attack+3','"Triple Atk."+4','Accuracy+4',}},
    neck="Sanctity necklace",
    ...
    sets.engaged.Hybrid = {
       -- head="Malignance Chapeau", --6/6
        body="Malignance Tabard", --9/9
        hands="Malignance Gloves", --5/5
        legs="Chasseur's Culottes +3", --12/12
        feet="Malignance Boots", --4/4
		ring1="Defending Ring", --10/10
    ...
    sets.TreasureHunter = {head="White Rarab Cap +1", legs={ name="Herculean Trousers", augments={'CHR+4','"Fast Cast"+3','"Treasure Hunter"+2',}}, waist="Chaac Belt"}

    sets.DeathPenalty_M = {main="Naegling", sub="Gleti's Knife", ranged="Death Penalty"}
   ...
   -- sets.DeathPenalty_R.Acc = {main="Lanun Knife", sub={name="Rostam", bag="wardrobe"}, ranged="Death Penalty"}
    sets.Armageddon_M = {main="Naegling", sub="Tauret", ranged="Death Penalty"}
   -- sets.Armageddon_M.Acc = {main="Naegling", sub="Tauret", ranged="Death Penalty"}
    sets.Armageddon_R = {main="Lanun Knife", sub="Rostam", ranged="Fomalhaut"}
   -- sets.Armageddon_R.Acc = sets.Armageddon_R
    sets.Fomalhaut_M = {main="Naegling", sub="Gleti's Knife", ranged="Fomalhaut"}
   -- sets.Fomalhaut_M.Acc = {main="Naegling", sub="Gleti's Knife", ranged="Fomalhaut"}
    sets.Fomalhaut_R = {main="Naegling", sub="Tauret", ranged="Fomalhaut"}
   -- sets.Fomalhaut_R.Acc = {main="Lanun Knife", sub="Rostam", ranged="Fomalhaut"}
    sets.Ataktos = {main="Naegling", sub="Gleti's Knife", ranged="Anarchy +2"}
