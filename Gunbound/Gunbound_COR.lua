...
function job_setup()
    ...
    state.Currentqd = M {
        ['description'] = 'Current Quick Draw',
        'Main',
        'Alt'
    }
    ...
    no_swap_gear = S {"Warp Ring", "Dim. Ring (Dem)", "Dim. Ring (Holla)", "Dim. Ring (Mea)", "Trizek Ring",
                      "Echad Ring", "Facility Ring", "Capacity Ring", "Dev. Bul. Pouch", "Chr. Bul. Pouch",
                      "Liv. Bul. Pouch"}
...
function init_gear_sets()
    ...
    sets.precast.RA.Flurry = set_combine()
    sets.precast.RA.Flurry2 = set_combine()

    sets.precast.RA.Flurry1 = set_combine() -- 48/49

    sets.precast.RA.Flurry2 = set_combine() -- 32/73
    ...
    sets.precast.WS['Savage Blade'].Acc = set_combine()

    sets.precast.WS['Swift Blade'] = set_combine()

    sets.precast.WS['Swift Blade'].Acc = set_combine()

    sets.precast.WS['Requiescat'] = set_combine() -- MND
    ...
    sets.engaged.LowAcc = set_combine()

    sets.engaged.MidAcc = set_combine()

    sets.engaged.HighAcc = set_combine()

    sets.engaged.STP = set_combine()
    ...
    sets.TreasureHunter = {
        ...
        legs = {
            ...
            augments = {'CHR+4', '"Fast Cast"+3', '"Treasure Hunter"+2'}
        },
        waist = "Chaac Belt"
    }
...
function display_current_job_state(eventArgs)
    ...
    add_to_chat(002,
        '| ' .. string.char(31, 210) .. 'Melee' .. cf_msg .. ': ' .. string.char(31, 001) .. m_msg ..
            ...
            string.char(31, 002) .. ' |' .. string.char(31, 060) .. ' QD' .. qd_msg .. ': ' .. string.char(31, 001) ..
            e_msg .. string.char(31, 002) .. ' |' .. string.char(31, 004) .. ' Defense: ' .. string.char(31, 001) ..
            d_msg .. string.char(31, 002) .. ' |' .. string.char(31, 008) .. ' Idle: ' .. string.char(31, 001) .. i_msg ..
    ...
    if rollinfo then
        add_to_chat(001,
            string.char(129, 115) .. '  ' .. string.char(31, 210) .. spell.english .. string.char(31, 001) .. ' : ' ..
                ...
                string.char(31, 167) .. tostring(rollinfo.unlucky) .. string.char(31, 002) .. '  ' .. rollsize)
    end
end
