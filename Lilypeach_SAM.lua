...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Wakido Kabuto +2",hands={ name="Sakonji Kote +3", augments={'Enhances "Blade Bash" effect',}},back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Phys. dmg. taken-10%',}},}
	...
	sets.precast.WS['Stardiver'] = {
		...
		back={ name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10',}},
	}
    ...
    sets.Meikyo = {feet="Sakonji Sune-ate +1"}
