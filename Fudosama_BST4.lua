...
function job_setup()
    ...
    no_swap_gear = S {"Warp Ring", "Dim. Ring (Dem)", "Dim. Ring (Holla)", "Dim. Ring (Mea)", "Trizek Ring",
                      "Echad Ring", "Facility Ring", "Capacity Ring", "Emporox's Ring"}
...
mab_ready_moves = S {'Cursed Sphere', 'Venom', 'Toxic Spit', 'Venom Spray', 'Bubble Shower', 'Fireball',
                     ...
                     'Aqua Breath', 'Stink Bomb', 'Nectarous Deluge', 'Nepenthic Plunge', 'Foul Waters', 'Dust Cloud',
                     'Sheep Song', 'Scream', 'Dream Flower', 'Roar', 'Gloeosuccus', 'Palsy Pollen', 'Soporific',
                     'Geist Wall', 'Numbing Noise', 'Spoil', 'Hi-Freq Field', 'Sandpit', 'Sandblast', 'Filamented Hold',
                     'Spore', 'Infrasonics', 'Chaotic Eye', 'Blaster', 'Intimidate', 'Noisome Powder', 'TP Drainkiss',
                     'Jettatura', 'Spider Web', 'Corrosive Ooze', 'Molting Plumage', 'Swooping Frenzy',
                     'Pestilent Plume'}
...
function user_unload()
    enable('main', 'sub', 'range', 'ammo', 'head', 'body', 'hands', 'legs', 'feet', 'neck', 'waist', 'left_ear',
        'right_ear', 'left_ring', 'right_ring', 'back')
...
function init_gear_sets()
    ...
    sets.precast.JA['Killer Instinct'] = {
        main = {
            name = "Arktoi",
            augments = {'Accuracy+50', 'Pet: Accuracy+50', 'Pet: Attack+30'}
        },
        sub = "Kaidate",
    ...
    sets.precast.JA['Call Beast'] = {
        ...
        right_ear = {
            ...
            augments = {'System: 1 ID: 1676 Val: 0', 'Accuracy+14', 'Mag. Acc.+14', 'Pet: "Dbl. Atk."+7'}
        }
    }
    ...
    sets.precast.RA = {
        ...
        legs = {
            name = "Taeon Tights",
            augments = {'"Snapshot"+4', '"Snapshot"+5'}
        },
        feet = "Volte Spats",
        neck = {
    ...
    sets.midcast.Pet.Neutral = {
        ...
        head = {
            ...
            augments = {'Pet: Accuracy+20', 'Pet: Attack+20', 'Pet: "Dbl. Atk."+4'}
        },
        body = {
            name = "Nyame Mail",
            augments = {'Path: B'}
    ...
    sets.midcast.Pet.MaccReady = {
        ...
        back = {
            name = "Artio's Mantle",
            augments = {'Pet: M.Acc.+20 Pet: M.Dmg.+20', 'Accuracy+20 Attack+20', 'Pet: Mag. Acc.+10',
                        'Pet: "Regen"+10', 'Pet: Damage taken -5%'}
        }
    }
    ...
    sets.engaged.DW = {
        ...
        feet = {
            name = "Taeon Boots",
            augments = {'Accuracy+25', '"Dual Wield"+5', 'STR+5 DEX+5'}
        }, -- 9%
        neck = "Anu Torque",
        waist = "Reiki Yotai", -- 7%
    ...
    sets.CP = {
        back = {
            name = "Mecisto. Mantle",
            augments = {'Cap. Point+48%', 'CHR+3', 'Accuracy+2', 'DEF+10'}
        }
    }
    sets.Obi = {
...
function Weaponskill_Keybinds()
    ...
    if state.WeaponSet.value == 'None' or state.WeaponSet.value == 'MACC_Axe' or state.WeaponSet.value == 'Dolichenus' or
        state.WeaponSet.value == 'Ikenga_Axe' then
