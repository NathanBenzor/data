...
function init_gear_sets()
    ...
    sets.precast.WS['Sanguine Blade'] = {
        ...
        back = {
            name = "Sucellos's Cape",
            augments = {'INT+20', 'Mag. Acc+20 /Mag. Dmg.+20', 'Mag. Acc.+5'}
        }
    }
    ...
    sets.midcast['Enhancing Magic'] = {
        ...
        back = {
            name = "Ghostfyre Cape",
            augments = {'Enfb.mag. skill +2', 'Enha.mag. skill +8', 'Mag. Acc.+3', 'Enh. Mag. eff. dur. +20'}
        }
    }

    sets["RDM Enhancing Others"] = {
        main = {
            name = "Colada",
            augments = {'Enh. Mag. eff. dur. +3', 'STR+2'}
        },
    ...
    sets.midcast['Phalanx'] = set_combine(sets.midcast.EnhancingDuration, {
        ...
        feet = {
            ...
            augments = {'AGI+15', 'Crit. hit damage +3%', 'Phalanx +2', 'Mag. Acc.+18 "Mag.Atk.Bns."+18'}
        }
    })
    ...
    sets.midcast.Sleep = set_combine(sets.midcast.IntEnfeeblesAcc, {
        ...
        legs = {
            name = "Chironic Hose",
            augments = {'"Occult Acumen"+6', 'Mag. Acc.+25', 'Quadruple Attack +1', 'Mag. Acc.+11 "Mag.Atk.Bns."+11'}
        },
        neck = {
            name = "Dls. Torque +2",
            augments = {'Path: A'}
    ...
    -- sets.CroceaDark = {main={ name="Crocea Mors", augments={'Path: C',}}, sub="Ternion Dagger +1"}
    sets.CroceaLight = {
        main = {
            name = "Crocea Mors",
            augments = {'Path: C'}
